...
const SignUp = ({onClose}) => { 
  ...
  return (
            <div id='signUp' className="shadow-drop-2-center   signUp text-start  absolute top-1/4 z-10 bg-[var(--lightblue)]   flex flex-col items-center justify-center auto left-[13%]  md:left-1/4 lg:left-[32%]   ">
            ...
            <div className='bg-white rounded-lg w-fit  flex flex-col items-center justify-center px-12 py-6 '>
                ...
                <form className='flex flex-col item-start gap-3 mt-4 md:gap-6 ' > 
                    <div className='flex flex-col item-center md:flex-row md:gap-2   '>
                        <label  className='text-black mont font-medium text-sm md:text-base' >User Name :</label>
                        <input type="text" value={name} onChange={(e) => setName(e.target.value) } placeholder='Enter Username' className=' bg-white border-[1px] border-[var(--blue)] rounded-lg py-1 px-2 mt-2 md:mt-0 text-black ' />
                    </div>
                    ...
                    <div className='flex flex-col md:flex-row md:gap-4  '>
                        ...
                        <input type="password" value={password} onChange={(e) => setPassword(e.target.value) } placeholder='Enter your password' className=' bg-white border-[1px] border-[var(--blue)] rounded-lg py-1 px-2 mt-2  md:mt-0  text-black ' />
                    </div>

                    <div className='mt-2 flex flex-col items-center '>
                        <button type='submit'  className='rounded-2xl text-white bg-[var(--blue)] mont text-base font-semibold py-2 px-4 shadow-md mt-6 md:mt-3  ' onClick={Register} >Sign Up  </button>
